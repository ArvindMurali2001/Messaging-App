import 'package:communique/services/navigation_service.dart';
...
class AuthProvider extends ChangeNotifier {
  ...
  void loginUserWithEmailAndPassword(String _email, String _password) async {
    ...
    try {
      ...
      SnackBarService.instance.showSnackBarSuccess("You are logged in!");
      await DBService.instance.updateUserLastSeenTime(user.uid);
  ...
  void registerUserWithEmailAndPassword(String _email, String _password,
    ...
    try {
      ...
      SnackBarService.instance.showSnackBarSuccess("Welcome To Communique!");
      await DBService.instance.updateUserLastSeenTime(user.uid);
